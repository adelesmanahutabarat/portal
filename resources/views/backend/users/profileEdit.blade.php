...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                {{ html()->modelForm($userprofile, 'PATCH', route("$link.users.profileUpdate", $$module_name_singular->id))->class('form-horizontal')->attributes(['enctype'=>"multipart/form-data"])->open() }}
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            $required = "required";
                            ?>
                            {{ html()->label('No Handphone', $field_name) }} {!! fielf_required($required) !!}
                            {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required"]) }}
                            <small class="text text-danger font-weight-bold">Pastikan selalu update karena konfirmasi akan dikirim ke nomor ini</small>
                        </div>
                    </div>
                </div>
