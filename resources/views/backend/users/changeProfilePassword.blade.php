...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                {{ html()->form('PATCH', route("$link.users.changeProfilePasswordUpdate", $user->id))->class('form-horizontal')->open() }}
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    {{ html()->button($text = "<i class='fas fa-save'></i> Save", $type = 'submit')->class('btn btn-primary') }}
                                </div>
                            </div>
                        </div>
                    </div>
