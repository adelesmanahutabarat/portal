        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="float-right">
                    <a href="{{ route("backend.$module_name.create") }}" class="btn btn-primary m-1 btn-sm" data-toggle="tooltip" title="Create New"><i class="fas fa-plus-circle"></i> @lang("Create new :module_name", ['module_name'=>Str::title($module_name)])</a>
                </div>
            </div>
            <!--/.col-->
        </div>
