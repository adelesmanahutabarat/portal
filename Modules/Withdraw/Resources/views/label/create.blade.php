...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->form('POST', route("label.$module_name.store"))->attribute('enctype','multipart/form-data')->class('form')->open() }}

                @include ("withdraw::label.form")

                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            {{ html()->button($text = "<i class='fas fa-plus-circle'></i> " . ucfirst("Ajukan") . "", $type = 'submit')->class('btn btn-success') }}
                        </div>
                    </div>
                    <div class="col-6">
