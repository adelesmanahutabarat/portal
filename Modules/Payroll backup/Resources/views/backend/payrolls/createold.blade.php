...
<div class="card">
                                        ...
                                        <tr id="rec-1">
                                            ...
                                            <td>
                                                <select class="custom-select mb-2 select-user select-2"
                                                    name="id_card_number[]" id="id_card_number" required="true">
                                                    <option value="" selected>Select Karyawan</option>
                                                    @foreach ($users as $item)
                                                    <option value="{{ $item->id_card_number }}">
                                                        {{ $item->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <tfoot>
                                        <tr id="rec-1">
                                            ...
                                            <td> <input type="text" class="form-control input-element input-total"
                                                    id="total" name="estimated_price" placeholder="" readonly></td>
                                            <td></td>
                                        </tr>
                                    </tfoot>
                                </table>
    ...
    <table id="sample_table" style="display:none;">
        <tr id="">
            ...
            <td>
                <select class="custom-select mb-2 select-user select-2" name="id_card_number[]" id="id_card_number"
                    required="true">
                    <option value="" selected>Select Karyawan</option>
                    @foreach ($users as $item)
                    <option value="{{ $item->id_card_number }}">
