...
use Log;
use App\Models\User;
use Modules\Master\Entities\EmployeeStatus;
...
class EmployeeStatusController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Employee Status';

        // module name
        $this->module_name = 'employeestatus';

        // directory path of the module
        $this->module_path = 'employeestatus';

        // module icon
        $this->module_icon = 'c-icon far fa-address-book';

        // module model name, path
        $this->module_model = "Modules\Master\Entities\EmployeeStatus";
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', 'employeestatus')
        );
    }
